...
plt.suptitle("Forecasting Performance for China (Time Series Models)", fontsize=16)
plt.tight_layout(rect=[0, 0.03, 1, 0.95])

# 保存
save_path = os.path.join(output_dir, "china_case_comparison.png")
